...
export const products: Product[] = [
  {
    ...
    href: "/atlas",
    tagline: "Deterministic engineering intelligence for JavaScript, TypeScript & Python.",
    description:
      "Maps your whole JavaScript, TypeScript, React, Next.js, and Python project — imports, boundaries, framework model, and the dependency manifest — through one shared semantic IR, and reports problems it can prove: circular imports, dead files, Next.js server/client leaks, React hook misuse, unused dependencies, hardcoded secrets, oversized functions. Native Rust, with an evidence chain for every finding.",
